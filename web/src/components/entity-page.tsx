...
export function PublicEntityPage({ page, navigation }: { page: EntityPage; navigation: Navigation }) {
  ...
  return <><SiteHeader /><div className="page-grid">
    ...
    <main className="main-content entity-page">
      ...
      {page.kind === "question" && <EntitySection icon={<BarChart3 />} title="Ways to look at it"><div className="chart-grid">{charts.slice(0, 3).map((chart) => <ChartCard key={chart.href} item={chart} />)}</div></EntitySection>}
